...
const images = [
  {
    url: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/HD-wallpaper-sasuke-uchiha-sasuke-uchiha-naruto-anime-artwork-digital-art.jpg-IWGx1sGnYZfoyvfVwTkeIBKJ2kmFes.jpeg",
...
export default function SasukeCarousel() {
